...
#define LOWER_KC MO(_LOWER)
#define RAISE_KC MO(_RAISE)
...
// Semi-macro
#define TERM_MCRO LCTL(LALT(KC_T))
#define SS_MCRO LWIN(LSFT(KC_S))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         KC_LCTL, LOWER_KC, KC_SPC,     KC_SPC, RAISE_KC, TD(TD_ALT)
                                      //|--------------------------|  |--------------------------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     TERM_MCRO, SS_MCRO, XXXXXXX, XXXXXXX, KC_VOLU, KC_HOME,             KC_END , RALT(KC_PSCR), XXXXXXX, XXXXXXX, KC_UP, KC_DEL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     KC_LSFT, XXXXXXX, XXXXXXX, KC_MPRV, KC_VOLD, KC_MNXT,                     XXXXXXX , KC_MYCM, XXXXXXX, KC_LEFT,  KC_DOWN, KC_RGHT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         LCTL(KC_LALT), KC_TRNS, KC_SPC,    KC_SPC, RAISE_KC, KC_RALT
                                      //|--------------------------|  |--------------------------|
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     KC_LSFT, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,                               KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_BSLS, KC_ENT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, LOWER_KC, KC_SPC,    KC_SPC, KC_TRNS, KC_RALT
                                      //|--------------------------|  |--------------------------|
  ),
